    ...
    <div class="alert alert-success">
       ...
       <p class="lead"> Dear PR Manager</p>
...
<br/>
<br/>
<span class="label label-important">Standard</span><br/>
<input type="text" style="width: 500px" value="<?php echo site_url('invitation').'/index/'. $m_id; ?>"/>
